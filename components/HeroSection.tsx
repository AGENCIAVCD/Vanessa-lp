...
export function HeroSection({
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid min-h-[100svh] w-full max-w-7xl items-center px-5 pb-10 pt-28 sm:px-8 sm:pt-28 lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)] lg:px-10 lg:pb-8 lg:pt-24">
        <div className="max-w-[670px]">
          <div
            className="inline-flex max-w-full items-center gap-2 border-l-2 border-rosegold bg-white/80 px-3 py-2 shadow-soft backdrop-blur"
            data-hero-copy
            data-hero-item
          >
            <span aria-hidden="true" className="text-sm">🔒</span>
            <span className="font-body text-[10px] font-bold uppercase tracking-[0.18em] text-forest sm:text-[11px]">
              ACESSO EXCLUSIVO NO GRUPO DE WHATSAPP
            </span>
          </div>

          <div
            className="mt-5 inline-flex items-center gap-4"
            data-hero-copy
            data-hero-item
          >
            <Image
              alt="Logo Protocolo Reset"
              className="h-auto w-[88px] rounded-md border border-rosegold/25 bg-white/86 shadow-luxe sm:w-[102px] lg:w-[94px]"
              height={1254}
              priority
            ...
            <p className="font-body text-[11px] font-bold uppercase tracking-[0.18em] text-forest">
              Especial Dia das Mães
            </p>
          </div>

          <h1
            className="mt-5 max-w-[9.5ch] font-display text-[3.55rem] uppercase leading-[0.86] text-forest sm:text-[5.2rem] lg:text-[5.9rem]"
            data-hero-copy
            data-hero-item
          >
            PROTOCOLO RESET
          ...
          <div className="mt-4 h-px w-36 bg-rosegold" data-hero-copy data-hero-item />

          <p
            className="mt-4 max-w-2xl font-body text-sm font-extrabold uppercase leading-6 tracking-[0.05em] text-[#1B332D] sm:text-base sm:leading-7"
            data-hero-copy
            data-hero-item
          >
          ...
          <p
            className="mt-3 max-w-xl font-body text-base font-medium leading-7 text-ink sm:text-[1.05rem]"
            data-hero-copy
            data-hero-item
          >
          ...
          <div
            className="mt-5 flex flex-wrap gap-3 font-body text-xs font-bold uppercase tracking-[0.08em] text-forest"
            data-hero-copy
            data-hero-item
          >
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center" data-hero-copy data-hero-item>
            <WhatsappButton
            ...
            <div className="inline-flex items-center justify-center gap-2 border border-rosegold/40 bg-white/86 px-4 py-3 shadow-soft backdrop-blur">
          ...
          <p
            className="mt-3 max-w-lg font-body text-sm font-semibold leading-6 text-ink/85"
            data-hero-copy
            data-hero-item
          >
        ...
        <div className="hidden lg:block" aria-hidden="true">
          <div className="absolute bottom-10 right-10 max-w-[330px] border border-white/30 bg-forest/88 p-5 text-white shadow-soft backdrop-blur-md">
            <p className="font-body text-[10px] font-bold uppercase tracking-[0.22em] text-rosegold">
              Grupo reservado
            </p>
            <p className="mt-2 font-display text-3xl leading-none">{availableSpots} vagas</p>
            <p className="mt-2 font-body text-sm font-medium leading-6 text-white/90">
